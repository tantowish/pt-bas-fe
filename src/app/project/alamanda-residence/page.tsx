    ...
    <div className='pt-16 pb-4 lg:pb-0 lg:pt-8'>
      <div className="max-w-7xl p-8 lg:px-24 lg:py-24 md:px-16 md:py-16 mx-auto">
        ...
        <div className='mb-8 md:mb-12'>
            <Image 
            src="/portfolio/alamanda-residence/main.jpg"
            alt='main' 
            width={1200}
            height={500}
            ...
            />
            <h2 className='text-lg font-semibold mt-4'>Alamanda Residence</h2>
            <p className='text-sm md:text-base text-slate-600'>Jl. Sulaiman Amin, Palembang, Sumatera Selatan</p>
        </div>
        <div className='text-slate-600'>
            <p className='text-sm md:text-base text-justify leading-6'>Alamanda Residence adalah perumahan yang berlokasi di Jl. Sulaiman Amin. Rumah-rumah di Alamanda Residence dibangun dengan desain yang modern dan minimalis. Rumah-rumah ini dilengkapi dengan berbagai fasilitas, seperti carport.
            </p>
            <p className='text-sm md:text-base text-justify leading-6 mt-4 md:mt-8'>Alamanda Residence merupakan pilihan yang tepat bagi Anda yang mencari hunian yang asri, nyaman, dan tertata rapi. Perumahan ini menawarkan berbagai tipe rumah yang dapat disesuaikan dengan kebutuhan Anda.</p>
        </div>
        <div className='flex flex-col gap-6 sm:grid sm:grid-cols-9 sm:grid-rows-2 grid-cols-1 grid-rows-1 mt-8 sm:gap-4'>
            ...
            src="/portfolio/alamanda-residence/1.jpg"
            alt='cendana-asri-2' 
            width={825}
            height={450}  
            loading='eager'          
            ...
            src="/portfolio/alamanda-residence/3.jpg"
            alt='cendana-asri-2' 
            width={825}
            height={450}  
            loading='eager'          
            ...
            src="/portfolio/alamanda-residence/4.jpg"
            alt='cendana-asri-2' 
            width={825}
            height={450}  
            loading='eager'          
            ...
            <Image 
            className='w-full h-full object-cover col-span-3 row-span-1 grayscale hover:grayscale-0 transition duration-500 ease-in-out'
            src="/portfolio/alamanda-residence/5.jpg"
            alt='cendana-asri-2' 
            width={825}
            height={450}  
            loading='eager'          
